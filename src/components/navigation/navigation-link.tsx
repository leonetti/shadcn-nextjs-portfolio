  ...
  return (
    <NavigationMenuItem asChild>
      <Link href={href} legacyBehavior passHref>
        <NavigationMenuLink className="text-neutral-400 hover:text-neutral-200 flex p-1 rounded stroke-0 hover:stroke-neutral-100 stroke-neutral-400 hover:text-neutral-100 place-items-center gap-3 hover:bg-neutral-700/30 transition-colors duration-100">
